...
public class AdminTemuShopController {
	...
	@Operation(summary = "店铺分页 用户版")
	public CommonResult<PageResult<TemuShopRespVO>> getShopPageForUser(@Valid TemuShopPageReqVO pageVO) {
		//获取当前用户id
		Long userId = SecurityFrameworkUtils.getLoginUserId();
		pageVO.setUserId(userId);
		return success(temuShopService.getShopPageForUser(pageVO));
	}
} 