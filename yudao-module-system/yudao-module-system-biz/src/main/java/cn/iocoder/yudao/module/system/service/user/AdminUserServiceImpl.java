...
import cn.iocoder.yudao.module.system.dal.mysql.user.AdminTemuShopMapper;
...
public class AdminUserServiceImpl implements AdminUserService {
	...
	@Resource
	private AdminTemuShopMapper shopMapper;
	...
	@Override
	public List<AdminTemuShopDO> getShopList(Long userId) {
		return shopMapper.getShopList(userId);
	}
	...
	public Long registerUser(AuthRegisterReqVO registerReqVO) {
		...
		userMapper.insert(user);
		//插入默认角色和部门
		RoleDO role = roleMapper.selectByCode("common");
		if (role != null) {
			userRoleMapper.insert(new UserRoleDO().setUserId(user.getId()).setRoleId(role.getId()));
		}
		//插入默认部门
		DeptDO dept = deptMapper.selectByParentIdAndName(0L, "禹链信息科技");
		if (dept != null) {
